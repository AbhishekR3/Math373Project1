# -*- coding: utf-8 -*-
"""
Created on Mon Mar  8 21:26:21 2021
...
#%% Loading Datasets
titanic_train = pd.read_csv('train.csv', sep = ',', header = 0)
titanic_test = pd.read_csv('test.csv', sep = ',', header=0)

titanic_test1 = pd.read_csv('test.csv', sep = ',', header=0)
